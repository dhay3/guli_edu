...
public class Generator {
    ...
    public void test() throws SQLException {
        System.out.println(memberService.queryRegisterCountByDate("2019-01-02"));
    }
...
//        gc.setActiveRecord()
        ...
        strategyConfig.setCapitalMode(false)
                ...
                //设置想要生成的表
                .setInclude("ucenter_member")
                //生成的dao,service,entity不再带tbl_前缀
                .setTablePrefix("ucenter_")
        ...
        packageConfig.setModuleName("edumember")
                .setParent("com.chz")
                .setMapper("mapper")
                .setService("service")
