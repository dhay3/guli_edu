                  ...
                  <section class="mt20">
                    <div class="lh-menu-wrap">
                      <menu id="lh-menu" class="lh-menu mt10 mr10">
                        <ul>
                          <!-- 文件目录 -->
                          <li class="lh-menu-stair" v-for="ChapterVideo in ChapterVideoList" :key="ChapterVideo.id">
                            ...
                            <ol class="lh-menu-ol" style="display: block;">
                              <li class="lh-menu-second ml30" v-for="video in ChapterVideo.children" :key="video.id">
                                <a :href="'/video/'+video.videoSourceId" :title="video.title" target="_blank">
                                  <span class="fr">
...
<script>
  ...
  export default {
    asyncData({params, error}) {
      return course.getFrontCourseDetailsByCourseId(params.id)
        .then(response => {
          return {
