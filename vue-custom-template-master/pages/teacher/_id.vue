      ...
      <div class="t-infor-wrap">
        ...
        <section class="fl t-infor-box c-desc-content">
          <div class="mt20 ml20">
            ...
            <h3 class="hLh30">
              <span class="fsize24 c-333">{{teacher.name}}&nbsp;{{teacher.level == 1?'首席讲师':'高级讲师'}}</span>
            </h3>
            <section class="mt10">
...
<script>
  ...
  export default {
    asyncData({params, error}) {
      // this.$route.params.id 等价 params.id
      return teacher.getTeacherDetailsById(params.id)
        .then(response => {
          return {
